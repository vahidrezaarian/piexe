...
public static class CustomIcons
{
    ...
    public static DrawingImage Barcode(Color color)
    {
        var drawingGroup = new DrawingGroup();
        var mainGeometry = Geometry.Parse(
            "M2 4h2v16H2V4zm4 0h2v16H6V4zm3 0h3v16H9V4zm4 0h2v16h-2V4zm3 0h2v16h-2V4zm3 0h3v16h-3V4z");
        var mainDrawing = new GeometryDrawing(new SolidColorBrush(color), null, mainGeometry);
    ...
    public static DrawingImage QRCode(Color color)
    {
        var drawingGroup = new DrawingGroup();
        var mainGeometry = Geometry.Parse(
    ...
    public static DrawingImage Document(Color color)
    {
        var drawingGroup = new DrawingGroup();
        var mainGeometry = Geometry.Parse(
            ...
            "C105,131.209 106.791,133 109,133 L" +
            "127,133 C129.209,133 131,131.209 131,129 L131,109 L123,101.028 Z");
        var mainDrawing = new GeometryDrawing(new SolidColorBrush(color), null, mainGeometry);
        drawingGroup.Children.Add(mainDrawing);
        var drawingImage = new DrawingImage(drawingGroup);
        drawingImage.Freeze();
    ...
    public static DrawingImage PowerShell(Color color)
    {
        var drawingGroup = new DrawingGroup();
        var mainGeometry = Geometry.Parse(
    ...
    public static DrawingImage OpenFolder(Color color)
    {
        var drawingGroup = new DrawingGroup();
        ...
        drawingGroup.Children.Add(new GeometryDrawing(new SolidColorBrush(color), null, bottomGeometry));
        ...
        drawingGroup.Children.Add(new GeometryDrawing(new SolidColorBrush(color), null, topGeometry));
        var drawingImage = new DrawingImage(drawingGroup);
        drawingImage.Freeze();
        return drawingImage;
    }

    public static DrawingImage Link(Color color)
    {
        var drawingGroup = new DrawingGroup();
        var mainGeometry = Geometry.Parse(
            "M16.19 2H7.81C4.17 2 2 4.17 2 7.81V16.18C2 19.83 4.17 22 7.81 22H16.18C19.82 22 21.99 19.83 21.99 16.19V7.81C22 4.17 19.83 2 16.19 2Z " +
